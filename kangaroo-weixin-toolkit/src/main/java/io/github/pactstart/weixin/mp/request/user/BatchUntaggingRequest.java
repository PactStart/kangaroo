 ...
 */
public class BatchUntaggingRequest extends AbstractAccessTokenRequest<DefaultJsonResponse> {

    private int tagId;

    private List<String> openidList;

    public BatchUntaggingRequest(int tagId, List<String> openidList) {
        this.tagId = tagId;
    ...
    public String getRequestPath() {
        return "/cgi-bin/tags/members/batchuntagging?access_token=" + getAccessToken();
    }
