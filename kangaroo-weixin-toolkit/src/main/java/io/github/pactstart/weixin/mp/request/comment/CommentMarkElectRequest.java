 ...
 */
public class CommentMarkElectRequest extends AbstractAccessTokenRequest<DefaultJsonResponse> {
    ...
    public String getRequestPath() {
        return "/cgi-bin/comment/markelect?access_token=" + getAccessToken();
    }
