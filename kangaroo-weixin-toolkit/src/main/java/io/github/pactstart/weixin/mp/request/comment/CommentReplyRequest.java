 ...
 */
public class CommentReplyRequest extends AbstractAccessTokenRequest<DefaultJsonResponse> {
    ...
    public String getRequestPath() {
        return "/cgi-bin/comment/reply/add?access_token=" + getAccessToken();
    }

    @Override
    public HttpEntity getRequestEntity() {
        String json = "{\"msg_data_id\":" + msgDataId + ",\"index\":" + index + ",\"user_comment_id\":" + userCommentId + ",\"content\":\"" + content + "\"}";
