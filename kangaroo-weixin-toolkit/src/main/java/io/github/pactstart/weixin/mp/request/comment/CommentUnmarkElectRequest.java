 ...
 */
public class CommentUnmarkElectRequest extends AbstractAccessTokenRequest<DefaultJsonResponse> {
    ...
    public String getRequestPath() {
        return "/cgi-bin/comment/unmarkelect?access_token=" + getAccessToken();
    }
