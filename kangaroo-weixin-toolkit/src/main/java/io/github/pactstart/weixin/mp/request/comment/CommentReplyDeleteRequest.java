 ...
 */
public class CommentReplyDeleteRequest extends AbstractAccessTokenRequest<DefaultJsonResponse> {
    ...
    public String getRequestPath() {
        return "/cgi-bin/comment/reply/delete?access_token=" + getAccessToken();
    }
